...
author: Prof. Eduardo
(Baseado nas aulas de Roger Peng, Johns Hopkins Bloomberg School  of Public Health e no livro "R for Data Science, Garrett Grolemund e Hadley Wickham)
hitheme: tomorrow
output:
  html_document: default
logo: null
mode: selfcontained
job: Departamento de Engenharia de Produção - UFSC
subtitle: Tipos de Dados e operações Básicas
framework: io2012
---
...
O objeto mais básico de um vetor

-   Um vetor pode conter apenas objetos da mesma classe
...
-   Se vocIf you explicitly want an integer, you need to specify the ```L```
    suffix
